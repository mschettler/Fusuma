...
@objc public class FusumaViewController: UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        let skipImage = fusumaCloseImage != nil ? fusumaCloseImage : UIImage(named: "ic_skip", in: bundle, compatibleWith: nil)
        
        closeButton.setImage(skipImage?.withRenderingMode(.alwaysTemplate), for: .normal)
        doneButton.setImage(checkImage?.withRenderingMode(.alwaysTemplate), for: .normal)
        closeButton.setImage(skipImage?.withRenderingMode(.alwaysTemplate), for: .selected)
